...
print (metro_poverty_boxplot)  # The bar plot shows that the poverty rate is higher in non-metropolitan areas than in metropolitan areas. 
```
...
print (edu_poverty_boxplot) # The bar plot shows that the poverty rate is lower in counties with higher education levels, and the relationship is stronger in non-metropolitan areas than in metropolitan areas.
